...
if has("gui_running")
  ...
  hi Cursor        gui=NONE    guifg=#404040    guibg=#404040
  ...
  hi LineNr        gui=NONE    guifg=#8b8bcd    guibg=NONE
  ...
  hi PreProc           gui=BOLD    guifg=#409090    guibg=NONE
  ...
  "hi Folded              cterm=bold    ctermfg=DarkGrey    ctermbg=lightblue
  ...
  hi LineNr              cterm=NONE    ctermfg=95     ctermbg=NONE
  ...
  hi Comment             cterm=NONE    ctermfg=30     ctermbg=NONE
  ...
  hi PreProc             cterm=BOLD    ctermfg=35     ctermbg=NONE
